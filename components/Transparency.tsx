    ...
    <section className="py-20 px-6">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative h-96 w-full glass-panel rounded-2xl border border-slate-700 p-8 shadow-sm flex flex-col justify-center items-center overflow-hidden bg-slate-800/30">
             <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-indigo-500 to-transparent opacity-50" />
             
             {/* Fake UI elements */}
             <div className="w-64 h-2 bg-slate-700 rounded-full mb-4 opacity-50" />
             <div className="w-48 h-2 bg-slate-700 rounded-full mb-12 opacity-30" />
             
             <div className="relative">
                <div className="w-16 h-16 bg-slate-800 rounded-xl flex items-center justify-center mb-4 mx-auto animate-bounce duration-[3000ms] border border-slate-700 shadow-xl">
          ...
          <div>
             ...
             <div className="space-y-8">
               <div className="flex gap-4">
                 ...
                 <div>
                   <h3 className="text-lg font-semibold text-white">100% Real Previews</h3>
               ...
               <div className="flex gap-4">
                 ...
                 <div>
                   <h3 className="text-lg font-semibold text-white">Verified Techniques</h3>
